...
class ContactListTest {
    ...
    public void editingSucceedsWithBlankLastName() {
        ...
        list.editContactFirstName(0, "Worm");
        assertEquals(contact.getFirstName(), "Worm");
        assertEquals(contact.getLastName(), "");
        assertEquals(contact.getPhoneNumber(), "");
        assertEquals(contact.getEmail(), "");

        list.editContactLastName(0, "Man");
        assertEquals(contact.getFirstName(), "Worm");
        assertEquals(contact.getLastName(), "Man");
        assertEquals(contact.getPhoneNumber(), "");
        assertEquals(contact.getEmail(), "");

        list.editContactFirstName(0, "");
        assertEquals(contact.getFirstName(), "");
        assertEquals(contact.getLastName(), "Man");
        assertEquals(contact.getPhoneNumber(), "");
        assertEquals(contact.getEmail(), "");
    ...
    public void editingSucceedsWithBlankPhone() {
        ...
        list.editContactPhoneNumber(0, "000-000-0000");
        assertEquals(contact.getFirstName(), "  ");
        assertEquals(contact.getLastName(), "");
    ...
    public void editingSucceedsWithNonBlankValues() {
        ...
        list.editContactFirstName(0, "First Name");
        ...
        list.editContactLastName(0, "Last Name");
        assertEquals("First Name", contact.getFirstName());
        assertEquals("Last Name", contact.getLastName());
        assertEquals("000-000-0000", contact.getPhoneNumber());
        assertEquals("a@b.z", contact.getEmail());

        list.editContactPhoneNumber(0, "999-999-9876");
        assertEquals("First Name", contact.getFirstName());
        assertEquals("Last Name", contact.getLastName());
        assertEquals("999-999-9876", contact.getPhoneNumber());
        assertEquals("a@b.z", contact.getEmail());

        list.editContactEmail(0, "Email@Email.Email");
        assertEquals("First Name", contact.getFirstName());
        assertEquals("Last Name", contact.getLastName());
        assertEquals("999-999-9876", contact.getPhoneNumber());
    ...
    public void removingItemsDecreasesSize() {
        ...
        list.addListItem(contact);
        list.addListItem(contact2);
        int initialSize = list.size();
        list.removeListItem(1);
        assertEquals(list.size(), initialSize - 1);
    ...
    public void removingItemsFailsWithInvalidIndex() {
        ...
        assertThrows(IndexOutOfBoundsException.class, () -> list.editContactPhoneNumber(-1, "011-235-8132"));
        assertThrows(IndexOutOfBoundsException.class, () -> list.editContactEmail(-1000000, "Nintendo@nintendo.com"));
    ...
    public void editToInvalidPhoneNumberFails() {
        ...
        list.addListItem(contact);
        list.addListItem(contact2);
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(0, "911"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(0, "a"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(0, "---"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(0, "000--0000"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(0, "a000-000-0000"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(0, " 000-000-0111"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(0, "ghbreuigbhnaerjigrfdnvb8345t6782345ty__["));

        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(1, "911"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(1, "a"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(1, "---"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(1, "000--0000"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(1, "a000-000-0000"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(1, " 000-000-0111"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactPhoneNumber(1, "ghbreuigbhnaerjigrfdnvb8345t6782345ty__["));
    ...
    public void editToInvalidEmailFails() {
        ...
        list.addListItem(contact);
        list.addListItem(contact2);
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(0, "a"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(0, "1"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(0, "@."));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(0, " @ . "));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(0, "1@3.6"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(0, "Valid Email Address"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(0, "a@@b..c"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(0, "a@b.c."));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(0, "@a@b.c."));

        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(1, "a"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(1, "1"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(1, "@."));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(1, " @ . "));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(1, "1@3.6"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(1, "Valid Email Address"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(1, "a@@b..c"));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(1, "a@b.c."));
        assertThrows(IllegalArgumentException.class, () -> list.editContactEmail(1, "@a@b.c."));
